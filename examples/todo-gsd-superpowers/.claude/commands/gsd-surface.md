...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/.gsd-surface.json`
(sibling to `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills`).
...
`/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/.gsd-surface.json`
Install profile marker: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/.gsd-profile`
Skill dirs: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills/gsd-*/`
Engine module: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
