...
**Verification depth scales with `asvs_level`** (see @/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
