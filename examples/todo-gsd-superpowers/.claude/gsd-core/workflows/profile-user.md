...
Key references:
- @/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md" "/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/CLAUDE.md
```
