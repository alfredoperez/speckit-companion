...
**If doesn't exist:** Create from template at `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/templates/retrospective.md`.
