...
<required_reading>
@/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/ai-frameworks.md
@/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/agents/gsd-eval-planner.md for instructions.
