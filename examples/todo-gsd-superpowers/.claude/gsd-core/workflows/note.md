...
- **Global scope**: `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/notes/`)
...
2. Glob `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/notes/` — works in any directory
