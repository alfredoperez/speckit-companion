...
The keys live in `.claude/settings.json` (project) or `/Users/alfredoperez/dev/GitHub/speckit-companion/examples/todo-gsd-superpowers/.claude/settings.json` (global) — **not** in `.planning/config.json`:
