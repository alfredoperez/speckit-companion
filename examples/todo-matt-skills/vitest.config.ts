...
// hidden grading key for adoption-ladder runs — they render the real app and
...
export default defineConfig({
  ...
  test: {
    ...
    // the bench harness (run-all.mjs capture) runs one acceptance file by passing its path.
