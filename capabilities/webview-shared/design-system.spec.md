...
The visual and accessibility floor every webview stands on: readable text meets contrast, hidden content stays in the accessibility tree, and new surfaces compose the shared primitives instead of re-implementing them. Without it, a design pass silently misses bespoke markup and users on dark themes or screen readers lose content.
