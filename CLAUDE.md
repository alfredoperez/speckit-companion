...
Three deliverables live here: the VS Code extension (`src/`, `webview/`, root `package.json`), the spec-kit extension (`speckit-extension/`), and the marketing site (`website/`).
