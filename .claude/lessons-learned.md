...
- **Copilot is fast** (~4–5 min) and earns its place — on #218 it caught two real correctness issues the local review had only flagged as "worth a glance"; on #238 it caught a leak in an optional-field derivation the local review had passed clean.
