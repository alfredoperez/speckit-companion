...
A region with nothing recorded in it doesn't render at all. A spec that recorded nothing shows a single line, "No activity recorded yet", rather than an empty scaffold.
