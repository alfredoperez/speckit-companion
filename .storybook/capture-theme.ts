 ...
 *   3. Re-run every capture and re-render every clip (capabilities/repo-tooling/produce-the-docs-media.spec.md).
 *
 ...
 * every clip (capabilities/repo-tooling/produce-the-docs-media.spec.md).
 */
