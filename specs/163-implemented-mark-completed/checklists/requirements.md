# Specification Quality Checklist: Implemented Mark-Completed + distinct icon
...
- The Approach/Success-Criteria reference theme-color names (`charts.yellow`) as informed defaults under Assumptions; the four spec body sections stay implementation-agnostic.
