# Specification Quality Checklist: Reorder Beta Features Settings
...
- No [NEEDS CLARIFICATION] markers — README anchor assumption is verified during implement (T003), not a spec-blocking ambiguity.
- Note: the Approach section in spec.md intentionally names files/properties (fast-path simple mode); the four numbered sections above remain implementation-free.
