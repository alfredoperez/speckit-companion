# Specification Quality Checklist: Launch prep — spec-kit extension discovery, safety & one-click install
...
- All items pass; spec is large (launch ticket) → routes to the **normal** full pipeline.
