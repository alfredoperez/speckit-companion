/**
 * The spec editor's wire contract: the workflow shape, the size limits, and
 * the two message unions.
 *
 * Both sides compile this: the extension fills it, the webview renders it.
