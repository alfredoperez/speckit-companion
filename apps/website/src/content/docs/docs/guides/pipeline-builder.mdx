...
[Custom commands and hooks](/docs/guides/customize) covers the same hooks written by hand, for when a file is faster than the panel. If the built-in workflows don't fit at all, [Pick a pipeline](/docs/discussions/pick-a-pipeline) has the option of defining your own outright.
