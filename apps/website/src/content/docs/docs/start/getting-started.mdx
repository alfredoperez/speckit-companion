...
Two directions from here. [Anatomy of the spec viewer](/docs/anatomy/anatomy-of-the-spec-viewer) names every part of the surface you used above. [Pick a pipeline](/docs/discussions/pick-a-pipeline) is the one decision worth making before your second spec.
