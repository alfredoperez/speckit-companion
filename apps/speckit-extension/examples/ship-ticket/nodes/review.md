...
2. Verify it builds before reviewing: `npm run compile && npm test`; if `speckit-extension/**` changed, also `python3 speckit-extension/scripts/check_shape_parity.py`. If anything is red, stop and report — don't ship a broken branch.
