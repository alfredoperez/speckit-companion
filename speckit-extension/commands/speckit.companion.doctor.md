---
description: "Report on a spec's run health — unfinished steps, unjournaled tasks, step bleed, drift you can judge, a step that closed having verified nothing, and why completion did not land (read-only, retroactive, never halts)"
---
