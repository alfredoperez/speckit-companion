<!-- IMAGE PATHS: every image below is referenced by RELATIVE path (./assets/... here in
...
<!-- These screenshots live in the ROOT repo at docs/screenshots/generated/ and are
     regenerated by scripts/capture-docs-images.mjs. -->
![A spec rendered as a structured page in the VS Code extension: requirements as labeled rows, the pipeline rail, and on-page navigation](../docs/screenshots/generated/spec-viewer.png)

![The Overview in the VS Code extension: run status with honest per-phase timing, task and coverage counts, and the plan's intent](../docs/screenshots/generated/overview-annotated.png)
