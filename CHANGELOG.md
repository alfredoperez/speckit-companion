...
- **A node says why it cannot be dragged.** Nodes free to move show a grip; ones held in place by something that reads them show a lock and name the node holding them.
